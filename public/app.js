	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        null,
	        React.createElement(Nav, { handler: this.liveUpdate.bind(this) }),
	        React.createElement(
	          "div",
	          { className: "col-md-7" },
	        ...
	        React.createElement(
	          "div",
	          { className: "col-md-5" },
	          React.createElement(VideoList, { videos: this.state.playList, handler: this.onVideoEntryClick.bind(this) })
	        )
	      );
	    }
	  }, {
	    key: "onVideoEntryClick",
	    value: function onVideoEntryClick(video) {
	      console.log('hi');
	      this.setState({
	        currentVideo: video
	      });
	    ...
	    key: "liveUpdate",
	    value: function liveUpdate(query) {
	    ...
	    key: "updateYouTube",
	    value: function updateYouTube(data) {
	      this.setState({
...
/***/ function(module, exports) {
	...
	var Search = function (_React$Component) {
	  ...
	  _createClass(Search, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement("input", { className: "form-control", type: "text",
	          ...
	          onChange: _.debounce(this.localHandler.bind(this), 500) }),
	        React.createElement(
	          "button",
	    ...
	    key: "localHandler",
	    value: function localHandler() {
	      this.props.handler(this.search.value);
	    }
	  }]);
	...
	var Nav = function Nav(props) {
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(Search, { handler: props.handler })
	    )
	  );
	};
	...
	var VideoList = function VideoList(props) {
	  return React.createElement(
	    ...
	    props.videos.map(function (video) {
	      return React.createElement(VideoListEntry, { video: video, handler: props.handler });
	    })
	  );
	};
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement("iframe", { className: "embed-responsive-item",
	        src: Object.keys(props.video).length ? "https://www.youtube.com/embed/" + props.video.id.videoId : "", allowFullScreen: true })
	    ),
	    React.createElement(
	      "div",
	      ...
	      React.createElement(
	        "h3",
	        null,
	        Object.keys(props.video).length ? props.video.snippet.title : ""
	      ),
	      React.createElement(
	        "div",
	        null,
	        Object.keys(props.video).length ? props.video.snippet.description : ""
	      )
	    )
	  );
	};
